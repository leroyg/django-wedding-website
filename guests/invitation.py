...
def send_invitation_email(party, test_only=False, recipients=None):
    ...
    msg = EmailMultiAlternatives(subject, template_text, 'Madison and Ryan <leroy.gardner@gmail.com>', recipients,
                                 cc=['Madison <noone@leroygardner.com>'],
                                 reply_to=['me@leroygardner.dev'])
    ...
    print('sending invitation to {} ({})').format(
